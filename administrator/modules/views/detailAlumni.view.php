...
<ol class="breadcrumb" style="font-size: 15px">
  ...
  <li>
    <a href="#"><span class="fa fa-user"></span> Detail Alumni</a>
  </li>
</ol>
<div class="col-xs-12">
...
<div class="col-md-12 col-xs-12 col-lg-12">
	<div class="x_panel">
		<div class="x_title">
			<h2><i class="fa fa-cap-graduation"></i> Detail Alumni</h2>
		...
		<div class="x_content">
			<div class="col-lg-3 col-xs-6">
				<?php if($data['siswa']->images) {?>
					<img src="public/images/alumni/<?php echo $data['siswa']->images; ?>" width="100%">
				<?php } else {?>
